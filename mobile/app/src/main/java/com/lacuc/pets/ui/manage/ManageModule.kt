...
import com.lacuc.pets.ui.manage.animal.detail.medical.SaveMedicalFragment
...
import com.lacuc.pets.ui.manage.group.item.save.SaveItemFragment
...
abstract class ManageModule {
    ...
    @ContributesAndroidInjector
    abstract fun getAddMedicalFragment(): SaveMedicalFragment
    ...
    @ContributesAndroidInjector
    abstract fun getSaveItemFragment(): SaveItemFragment
}